...
1. "tdf_feature" — מיני-כתבה על הטור דה פראנס של היום:
   ...
   - "jerseys_he": מערך של בדיוק 4 מחרוזות — לובשי כל ארבע החולצות, תמיד לפי הסדר הזה: "🟡 צהובה (מוביל כללי): שם", "🟢 ירוקה (נקודות): שם", "🔴 מנוקדת (מלך ההרים): שם", "⚪ לבנה (רוכב צעיר): שם". חובה לחלץ את כל ארבעת השמות מתוך הידיעות — מאמרי דירוגים ותוצאות כמעט תמיד מפרטים את כל ארבע החולצות, כולל בשדה details. אם לאחר חיפוש יסודי חולצה מסוימת אינה מופיעה כלל בידיעות, כתוב "טרם עודכן" במקום השם (למשל "🔴 מנוקדת (מלך ההרים): טרם עודכן"). לעולם אל תמציא שם — אך אל תשמיט אף חולצה. המערך יכיל תמיד 4 פריטים בדיוק
